...
import { Image, Text, View, StyleSheet, Dimensions, ScrollView, FlatList } from 'react-native';
    ...
    <SafeAreaView edges={['right', 'bottom', 'left']} style={{ paddingBottom: 20 }}>
      <ScrollView>
        ...
        <View style={styles.marginContainer}>
          ...
          <Text style={styles.subTitle}>{description == "" ? "No description to show." : description}</Text>
        </View>

        <View style={styles.marginContainer}>
          <Text style={[styles.subTitle, { fontWeight: "bold", paddingBottom: 10 }]}>Appears on:</Text>
          {
            heroHasComics
              ?
              <FlatList
                ...
                renderItem={({ item }) => {
                  return (
                    <View style={{ paddingRight: 10 }}>
                      <View style={{ padding: 15, backgroundColor: "lightgray", borderRadius: 10 }}>
